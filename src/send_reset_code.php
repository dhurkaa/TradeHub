...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $stmt = $conn->prepare("SELECT id FROM tradehub_users WHERE email = ?");
  ...
  if ($stmt->num_rows === 1) {
    ...
    // Send email
    mail($email, "TradeHub Reset Code", "Your code is: $code", "From: noreply@yourdomain.com");
...
<head>
  ...
  <title>Reset Password | TradeHub</title>
